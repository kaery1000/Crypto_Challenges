...
public class Set1_Challenge6 {

    /**STEP-2**///Returning the hammong distance 
    ...
    public static int hammingDistance(Data d1, Data d2) {
        ...
        for (int i = 0; i < d1Bytes.length; i++) {
            hammingDistCount += hammingDistance(d1Bytes[i], d2Bytes[i]);
        }
    ...
    private static int hammingDistance(byte b1, byte b2) {
        ...
        for (int i = 0; i < byteLength; i++) {
            b1Bit = (b1 >> i) & 1;  //using right shift to filter out 1 bit at time
            b2Bit = (b2 >> i) & 1; 
            if (b1Bit != b2Bit) {
                hammingDistCount += 1;
            }
    ...
    /*** STEP 3 ***/// find the edit distance between them and normalizing
    ...
    /*** STEP 4 ***/// Return the most likely key size given encryption, a Data object.    
    ...
    /*** STEP 5 ***///breaking the ciphertext into blocks of KEYSIZE length.
    ...
    /*** STEP 6 ***/// Return an array of Data objects that is the transpose of chunks.
    ...
    /*** STEP 7 ***/// Return an array of XORDecryptions corresponding to the Data objects in cols.
    ...
    /*** STEP 8 ***//* Return a RepKeyXORDecryption representing the most likely decryption of the enc encoded data*/
    ...
    throws IOException {
        ...
        RepKeyXORDecryption result = new RepKeyXORDecryption(key, plaintext, new Data(ciphertext, enc));
        return result;
    }
