...
public class Set1Challenge7 {
     ...
     /*Return an AESECBDecryption representing the decryption of the encoded data found in filename with the key.*/
    public static AESECBDecryption aesECBDecryptFile(String key, String filename, Data.Encoding enc) throws IOException, IllegalArgumentException {
        ...
        try {
            ...
            throw new IllegalArgumentException("Failed to decrypt contents of " + filename, e);
        }
        return result;
    }
